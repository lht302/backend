...
module MSHR(
  ...
  wire        req_clientBit = request_source[8:3] == 6'h20 & request_source[2:0] < 3'h5;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:98:20, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:270:13, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:52:56, :54:{10,32}, :56:48, :57:20]
  ...
  wire        _final_meta_writeback_clients_T_7 = evict_c & ~((request_param == 3'h1 | request_param == 3'h2 | request_param == 3'h5) & req_clientBit);	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:98:20, :100:17, :226:{50,52,56}, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:270:13, :282:{11,43,66,75}, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:56:48]
  ...
  wire        _final_meta_writeback_clients_T_14 = meta_hit & evict_c & ~probes_toN | req_acquire & req_clientBit;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17, :151:23, :219:53, :245:{40,66,84}, :246:40, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:56:48]
  ...
  wire [8:0]  new_request_source = io_allocate_valid ? io_allocate_bits_source : request_source;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:98:20, :506:24]
  ...
  wire        new_clientBit = new_request_source[8:3] == 6'h20 & new_request_source[2:0] < 3'h5;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:506:24, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:270:13, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:52:56, :54:{10,32}, :56:48, :57:20]
  ...
  wire        _GEN_44 = new_meta_hit & (new_needT | _GEN_37) & new_meta_clients & ~((_new_skipProbe_T | (&new_request_opcode) | new_request_opcode == 3'h4) & new_clientBit);	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:505:21, :506:24, :509:26, :578:56, :627:{24,53}, :628:33, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:270:70, :271:{14,52}, :279:{77,87}, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:56:48]
  ...
  wire        probe_bit = io_sinkc_bits_source[8:3] == 6'h20 & io_sinkc_bits_source[2:0] < 3'h5;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:270:13, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:52:56, :54:{10,32}, :56:48, :57:20]
  ...
  wire        last_probe = (probes_done | probe_bit) == (evict_c & ~excluded_client);	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17, :150:24, :279:28, :289:53, :459:{33,46,64}, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:56:48]
  ...
  always @(posedge clock) begin
    ...
    probes_done <= ~_GEN_4 & (io_sinkc_valid & probe_bit | probes_done);	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17, :150:24, :461:49, :467:17, :539:{28,79}, :541:10, :542:17, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:56:48]
    probes_toN <= ~_GEN_4 & (io_sinkc_valid & (io_sinkc_bits_param == 3'h1 | io_sinkc_bits_param == 3'h2 | io_sinkc_bits_param == 3'h5) & probe_bit | probes_toN);	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17, :151:23, :461:49, :468:16, :539:{28,79}, :541:10, :543:16, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:270:13, :282:{11,43,66,75}, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:56:48]
  end // always @(posedge)

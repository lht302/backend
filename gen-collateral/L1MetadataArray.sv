...
module L1MetadataArray(
  ...
  input  [7:0]  io_write_bits_way_en,	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:318:14]
  ...
  output [1:0]  io_resp_4_coh_state,	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:318:14]
  output [19:0] io_resp_4_tag,	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:318:14]
  output [1:0]  io_resp_5_coh_state,	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:318:14]
  output [19:0] io_resp_5_tag,	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:318:14]
  output [1:0]  io_resp_6_coh_state,	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:318:14]
  output [19:0] io_resp_6_tag,	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:318:14]
  output [1:0]  io_resp_7_coh_state,	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:318:14]
  output [19:0] io_resp_7_tag	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:318:14]
);

  wire [175:0] _tag_array_R0_data;	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:333:30]
  ...
  tag_array tag_array (	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:333:30]
    ...
    .W0_clk  (clock),
    .W0_data ({_wdata_T_coh_state, _wdata_T_tag, _wdata_T_coh_state, _wdata_T_tag, _wdata_T_coh_state, _wdata_T_tag, _wdata_T_coh_state, _wdata_T_tag, _wdata_T_coh_state, _wdata_T_tag, _wdata_T_coh_state, _wdata_T_tag, _wdata_T_coh_state, _wdata_T_tag, _wdata_T_coh_state, _wdata_T_tag}),	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:327:18, :333:30]
    .W0_mask (rst_cnt[6] ? io_write_bits_way_en : 8'hFF)	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:324:24, :325:21, :328:18]
  );
  ...
  assign io_resp_4_coh_state = _tag_array_R0_data[109:108];	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:333:30, :338:75]
  assign io_resp_4_tag = _tag_array_R0_data[107:88];	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:333:30, :338:75]
  assign io_resp_5_coh_state = _tag_array_R0_data[131:130];	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:333:30, :338:75]
  assign io_resp_5_tag = _tag_array_R0_data[129:110];	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:333:30, :338:75]
  assign io_resp_6_coh_state = _tag_array_R0_data[153:152];	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:333:30, :338:75]
  assign io_resp_6_tag = _tag_array_R0_data[151:132];	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:333:30, :338:75]
  assign io_resp_7_coh_state = _tag_array_R0_data[175:174];	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:333:30, :338:75]
  assign io_resp_7_tag = _tag_array_R0_data[173:154];	// @[generators/rocket-chip/src/main/scala/rocket/HellaCache.scala:333:30, :338:75]
endmodule

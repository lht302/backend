...
module MulAddRecFNToRaw_postMul_1(
  ...
  input  [4:0]  io_fromPreMul_CDom_CAlignDist,	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:170:16]
  ...
  wire [25:0]  _sigSum_T_3 = io_mulAddResult[48] ? io_fromPreMul_highAlignedSigC + 26'h1 : io_fromPreMul_highAlignedSigC;	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:190:{16,32}, :191:47]
  wire [49:0]  CDom_absSigSum = io_fromPreMul_doSubMags ? ~{_sigSum_T_3, io_mulAddResult[47:24]} : {1'h0, io_fromPreMul_highAlignedSigC[25:24], _sigSum_T_3[23:0], io_mulAddResult[47:25]};	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:190:16, :203:12, :204:{13,20}, :205:22, :207:{46,71}, :208:23]
  wire [80:0]  _CDom_mainSig_T = {31'h0, CDom_absSigSum} << io_fromPreMul_CDom_CAlignDist;	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:203:12, :217:24]
  wire [8:0]   CDom_reduced4SigExtra_shift = $signed(9'sh100 >>> ~(io_fromPreMul_CDom_CAlignDist[4:2]));	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:221:51, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:52:21, :76:56]
  ...
  wire [113:0] _notCDom_mainSig_T = {63'h0, notCDom_absSigSum} << {108'h0, notCDom_normDistReduced2, 1'h0};	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:205:22, :232:12, :241:27, src/main/scala/chisel3/util/Mux.scala:50:70]

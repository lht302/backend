...
module Queue_21(
  ...
  reg  [9:0] ram;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  always @(posedge clock) begin
    if (do_enq)	// @[src/main/scala/chisel3/util/Decoupled.scala:52:35]
      ram <= {io_enq_bits_extra_id, io_enq_bits_tl_state_source, io_enq_bits_tl_state_size};	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    if (reset)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = _RANDOM[/*Zero width*/ 1'b0][10:1];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  assign io_deq_bits_extra_id = ram[9];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule

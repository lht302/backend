  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_address = {_RANDOM[2'h0][31:20], _RANDOM[2'h1][16:0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_mask = _RANDOM[2'h1][24:17];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
        saved_corrupt = _RANDOM[2'h3][25];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial

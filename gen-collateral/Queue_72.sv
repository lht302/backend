...
module Queue_72(
  ...
  ram_2x62 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    .W0_clk  (clock),
    .W0_data ({17'hFFFF, io_enq_bits_address, 8'h6, io_enq_bits_param, 3'h6})	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95]
  );
  ...
  assign io_deq_bits_mask = _ram_ext_R0_data[60:45];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[61];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule

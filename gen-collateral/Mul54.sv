  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        val_s1 = _RANDOM[4'h0][0];	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecF64.scala:97:21]
        val_s2 = _RANDOM[4'h0][1];	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecF64.scala:97:21, :98:21]
        reg_a_s1 = {_RANDOM[4'h0][31:2], _RANDOM[4'h1][23:0]};	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecF64.scala:97:21, :99:23]
        reg_b_s1 = {_RANDOM[4'h1][31:24], _RANDOM[4'h2], _RANDOM[4'h3][13:0]};	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecF64.scala:99:23, :100:23]
        reg_a_s2 = {_RANDOM[4'h3][31:14], _RANDOM[4'h4], _RANDOM[4'h5][3:0]};	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecF64.scala:100:23, :101:23]
        reg_b_s2 = {_RANDOM[4'h5][31:4], _RANDOM[4'h6][25:0]};	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecF64.scala:101:23, :102:23]
        reg_result_s3 = {_RANDOM[4'h6][31:26], _RANDOM[4'h7], _RANDOM[4'h8], _RANDOM[4'h9], _RANDOM[4'hA][2:0]};	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecF64.scala:102:23, :103:28]
      `endif // RANDOMIZE_REG_INIT
    end // initial

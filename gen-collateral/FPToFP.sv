  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_out_pipe_v = _RANDOM[4'h6][31];	// @[src/main/scala/chisel3/util/Valid.scala:129:24]
        ...
        io_out_pipe_pipe_v = _RANDOM[4'h9][6];	// @[src/main/scala/chisel3/util/Valid.scala:129:24, :130:26]
        io_out_pipe_pipe_b_data = {_RANDOM[4'h9][31:7], _RANDOM[4'hA], _RANDOM[4'hB][7:0]};	// @[src/main/scala/chisel3/util/Valid.scala:130:26]
        io_out_pipe_pipe_b_exc = _RANDOM[4'hB][12:8];	// @[src/main/scala/chisel3/util/Valid.scala:130:26]
        io_out_pipe_pipe_pipe_v = _RANDOM[4'hB][13];	// @[src/main/scala/chisel3/util/Valid.scala:129:24, :130:26]
        io_out_pipe_pipe_pipe_b_data = {_RANDOM[4'hB][31:14], _RANDOM[4'hC], _RANDOM[4'hD][14:0]};	// @[src/main/scala/chisel3/util/Valid.scala:130:26]
        io_out_pipe_pipe_pipe_b_exc = _RANDOM[4'hD][19:15];	// @[src/main/scala/chisel3/util/Valid.scala:130:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial

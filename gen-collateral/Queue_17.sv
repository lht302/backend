...
module Queue_17(
  ...
  input        io_enq_bits_extra_id,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output       io_deq_bits_extra_id	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
);

  wire [9:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  ram_2x10 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_extra_id, io_enq_bits_tl_state_source, io_enq_bits_tl_state_size})	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  );
  ...
  assign io_deq_bits_extra_id = _ram_ext_R0_data[9];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule

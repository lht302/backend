...
module Atomics(
  ...
  wire [7:0][1:0] _GEN_1 = {{2'h0}, {2'h0}, {2'h0}, {2'h0}, {2'h3}, {io_a_param[2] ? 2'h2 : {1'h0, io_a_param[0] == ((|_sign_a_T_129) == (|({io_data_in[127], io_data_in[119], io_data_in[111], io_data_in[103], io_data_in[95], io_data_in[87], io_data_in[79], io_data_in[71], io_data_in[63], io_data_in[55], io_data_in[47], io_data_in[39], io_data_in[31], io_data_in[23], io_data_in[15], io_data_in[7]} & signBit)) ? ({_sum_T_50[127], _sum_T_50[119], _sum_T_50[111], _sum_T_50[103], _sum_T_50[95], _sum_T_50[87], _sum_T_50[79], _sum_T_50[71], _sum_T_50[63], _sum_T_50[55], _sum_T_50[47], _sum_T_50[39], _sum_T_50[31], _sum_T_50[23], _sum_T_50[15], _sum_T_50[7]} & signBit) == 16'h0 : io_a_param[1] == (|_sign_a_T_129))}}, {2'h1}, {2'h1}};	// @[generators/rocket-chip/src/main/scala/tilelink/Atomics.scala:18:28, :19:28, :20:28, :22:27, :24:57, :25:{33,36,83,94}, :29:32, :30:{21,29}, :31:25, :45:{19,42}, :48:8]
  wire [1:0]      select = io_write ? 2'h1 : _GEN_1[io_a_opcode];	// @[generators/rocket-chip/src/main/scala/tilelink/Atomics.scala:45:{19,42}]
  wire [3:0][7:0] _GEN_2 = {{{_logical_T_302[0], _logical_T_299[0], _logical_T_296[0], _logical_T_293[0], _logical_T_290[0], _logical_T_287[0], _logical_T_284[0], _logical_T_281[0]}}, {_sum_T_50[15:8]}, {io_a_data[15:8]}, {io_data_in[15:8]}};	// @[generators/rocket-chip/src/main/scala/tilelink/Atomics.scala:24:57, :41:8, :58:21, :59:59]
  wire [3:0][7:0] _GEN_3 = {{{_logical_T_278[0], _logical_T_275[0], _logical_T_272[0], _logical_T_269[0], _logical_T_266[0], _logical_T_263[0], _logical_T_260[0], _logical_T_257[0]}}, {_sum_T_50[7:0]}, {io_a_data[7:0]}, {io_data_in[7:0]}};	// @[generators/rocket-chip/src/main/scala/tilelink/Atomics.scala:24:57, :41:8, :58:21, :59:59]
  wire [3:0][7:0] _GEN_4 = {{{_logical_T_350[0], _logical_T_347[0], _logical_T_344[0], _logical_T_341[0], _logical_T_338[0], _logical_T_335[0], _logical_T_332[0], _logical_T_329[0]}}, {_sum_T_50[31:24]}, {io_a_data[31:24]}, {io_data_in[31:24]}};	// @[generators/rocket-chip/src/main/scala/tilelink/Atomics.scala:24:57, :41:8, :58:21, :59:59]
  wire [3:0][7:0] _GEN_5 = {{{_logical_T_326[0], _logical_T_323[0], _logical_T_320[0], _logical_T_317[0], _logical_T_314[0], _logical_T_311[0], _logical_T_308[0], _logical_T_305[0]}}, {_sum_T_50[23:16]}, {io_a_data[23:16]}, {io_data_in[23:16]}};	// @[generators/rocket-chip/src/main/scala/tilelink/Atomics.scala:24:57, :41:8, :58:21, :59:59]
  wire [3:0][7:0] _GEN_6 = {{{_logical_T_398[0], _logical_T_395[0], _logical_T_392[0], _logical_T_389[0], _logical_T_386[0], _logical_T_383[0], _logical_T_380[0], _logical_T_377[0]}}, {_sum_T_50[47:40]}, {io_a_data[47:40]}, {io_data_in[47:40]}};	// @[generators/rocket-chip/src/main/scala/tilelink/Atomics.scala:24:57, :41:8, :58:21, :59:59]
  wire [3:0][7:0] _GEN_7 = {{{_logical_T_374[0], _logical_T_371[0], _logical_T_368[0], _logical_T_365[0], _logical_T_362[0], _logical_T_359[0], _logical_T_356[0], _logical_T_353[0]}}, {_sum_T_50[39:32]}, {io_a_data[39:32]}, {io_data_in[39:32]}};	// @[generators/rocket-chip/src/main/scala/tilelink/Atomics.scala:24:57, :41:8, :58:21, :59:59]
  wire [3:0][7:0] _GEN_8 = {{{_logical_T_446[0], _logical_T_443[0], _logical_T_440[0], _logical_T_437[0], _logical_T_434[0], _logical_T_431[0], _logical_T_428[0], _logical_T_425[0]}}, {_sum_T_50[63:56]}, {io_a_data[63:56]}, {io_data_in[63:56]}};	// @[generators/rocket-chip/src/main/scala/tilelink/Atomics.scala:24:57, :41:8, :58:21, :59:59]
  wire [3:0][7:0] _GEN_9 = {{{_logical_T_422[0], _logical_T_419[0], _logical_T_416[0], _logical_T_413[0], _logical_T_410[0], _logical_T_407[0], _logical_T_404[0], _logical_T_401[0]}}, {_sum_T_50[55:48]}, {io_a_data[55:48]}, {io_data_in[55:48]}};	// @[generators/rocket-chip/src/main/scala/tilelink/Atomics.scala:24:57, :41:8, :58:21, :59:59]
  wire [3:0][7:0] _GEN_10 = {{{_logical_T_494[0], _logical_T_491[0], _logical_T_488[0], _logical_T_485[0], _logical_T_482[0], _logical_T_479[0], _logical_T_476[0], _logical_T_473[0]}}, {_sum_T_50[79:72]}, {io_a_data[79:72]}, {io_data_in[79:72]}};	// @[generators/rocket-chip/src/main/scala/tilelink/Atomics.scala:24:57, :41:8, :58:21, :59:59]
  wire [3:0][7:0] _GEN_11 = {{{_logical_T_470[0], _logical_T_467[0], _logical_T_464[0], _logical_T_461[0], _logical_T_458[0], _logical_T_455[0], _logical_T_452[0], _logical_T_449[0]}}, {_sum_T_50[71:64]}, {io_a_data[71:64]}, {io_data_in[71:64]}};	// @[generators/rocket-chip/src/main/scala/tilelink/Atomics.scala:24:57, :41:8, :58:21, :59:59]
  wire [3:0][7:0] _GEN_12 = {{{_logical_T_542[0], _logical_T_539[0], _logical_T_536[0], _logical_T_533[0], _logical_T_530[0], _logical_T_527[0], _logical_T_524[0], _logical_T_521[0]}}, {_sum_T_50[95:88]}, {io_a_data[95:88]}, {io_data_in[95:88]}};	// @[generators/rocket-chip/src/main/scala/tilelink/Atomics.scala:24:57, :41:8, :58:21, :59:59]
  wire [3:0][7:0] _GEN_13 = {{{_logical_T_518[0], _logical_T_515[0], _logical_T_512[0], _logical_T_509[0], _logical_T_506[0], _logical_T_503[0], _logical_T_500[0], _logical_T_497[0]}}, {_sum_T_50[87:80]}, {io_a_data[87:80]}, {io_data_in[87:80]}};	// @[generators/rocket-chip/src/main/scala/tilelink/Atomics.scala:24:57, :41:8, :58:21, :59:59]
  wire [3:0][7:0] _GEN_14 = {{{_logical_T_590[0], _logical_T_587[0], _logical_T_584[0], _logical_T_581[0], _logical_T_578[0], _logical_T_575[0], _logical_T_572[0], _logical_T_569[0]}}, {_sum_T_50[111:104]}, {io_a_data[111:104]}, {io_data_in[111:104]}};	// @[generators/rocket-chip/src/main/scala/tilelink/Atomics.scala:24:57, :41:8, :58:21, :59:59]
  wire [3:0][7:0] _GEN_15 = {{{_logical_T_566[0], _logical_T_563[0], _logical_T_560[0], _logical_T_557[0], _logical_T_554[0], _logical_T_551[0], _logical_T_548[0], _logical_T_545[0]}}, {_sum_T_50[103:96]}, {io_a_data[103:96]}, {io_data_in[103:96]}};	// @[generators/rocket-chip/src/main/scala/tilelink/Atomics.scala:24:57, :41:8, :58:21, :59:59]
  wire [3:0][7:0] _GEN_16 = {{{_logical_T_638[0], _logical_T_635[0], _logical_T_632[0], _logical_T_629[0], _logical_T_626[0], _logical_T_623[0], _logical_T_620[0], _logical_T_617[0]}}, {_sum_T_50[127:120]}, {io_a_data[127:120]}, {io_data_in[127:120]}};	// @[generators/rocket-chip/src/main/scala/tilelink/Atomics.scala:24:57, :41:8, :58:21, :59:59]
  wire [3:0][7:0] _GEN_17 = {{{_logical_T_614[0], _logical_T_611[0], _logical_T_608[0], _logical_T_605[0], _logical_T_602[0], _logical_T_599[0], _logical_T_596[0], _logical_T_593[0]}}, {_sum_T_50[119:112]}, {io_a_data[119:112]}, {io_data_in[119:112]}};	// @[generators/rocket-chip/src/main/scala/tilelink/Atomics.scala:24:57, :41:8, :58:21, :59:59]

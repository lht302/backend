...
module Queue_53(
  ...
  input  [3:0]  io_enq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [3:0]  io_deq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  wire [109:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  wire [3:0]   _ptr_diff_T = enq_ptr_value - deq_ptr_value;	// @[src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:327:32]
  ...
  ram_12x110 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    .W0_clk  (clock),
    .W0_data ({1'h0, io_enq_bits_data, io_enq_bits_address, io_enq_bits_source, 3'h6, io_enq_bits_param, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95]
  );
  ...
  assign io_deq_bits_address = _ram_ext_R0_data[44:13];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_data = _ram_ext_R0_data[108:45];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[109];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_count = ptr_match ? (maybe_full ? 4'hC : 4'h0) : deq_ptr_value > enq_ptr_value ? _ptr_diff_T - 4'h4 : _ptr_diff_T;	// @[src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:277:27, :278:33, :327:32, :332:20, :334:10, :335:{10,25,57}]
endmodule

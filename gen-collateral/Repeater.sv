...
module Repeater(
  ...
  input  [8:0]   io_enq_bits_source,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  input  [28:0]  io_enq_bits_address,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  input  [15:0]  io_enq_bits_mask,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  ...
  output [8:0]   io_deq_bits_source,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  output [28:0]  io_deq_bits_address,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  output [15:0]  io_deq_bits_mask,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  ...
  reg  [8:0]   saved_source;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
  reg  [28:0]  saved_address;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
  reg  [15:0]  saved_mask;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_param = _RANDOM[3'h0][6:4];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_size = _RANDOM[3'h0][10:7];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_source = _RANDOM[3'h0][19:11];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_address = {_RANDOM[3'h0][31:20], _RANDOM[3'h1][16:0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_mask = {_RANDOM[3'h1][31:17], _RANDOM[3'h2][0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
        saved_data = {_RANDOM[3'h2][31:1], _RANDOM[3'h3], _RANDOM[3'h4], _RANDOM[3'h5], _RANDOM[3'h6][0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
        saved_corrupt = _RANDOM[3'h6][1];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial

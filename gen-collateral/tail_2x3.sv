...
module tail_2x3(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/ListBuffer.scala:48:18]
  input        R0_addr,
               R0_en,
               R0_clk,
  output [2:0] R0_data,
  ...
  assign R1_data = R1_en ? Memory[R1_addr] : 3'bx;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/ListBuffer.scala:48:18]
endmodule

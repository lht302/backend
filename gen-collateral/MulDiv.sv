...
module MulDiv(
  ...
  wire         _eOut_T_9 = count == 7'h0;	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:51:18, :120:20, :143:24]
  ...
  always @(posedge clock) begin
    ...
    if (_GEN_5) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:52:35]
      ...
      if (_GEN_3) begin	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:126:39]
        if (_eOut_T_9 & ~divby0 & _eOutPos_T != 6'h3F) begin	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:114:45, :143:{24,32}, :149:35, :150:{35,43,54}]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        count = _RANDOM[4'h4][19:13];	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:51:18]
        neg_out = _RANDOM[4'h4][20];	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:51:18, :54:20]
        isHi = _RANDOM[4'h4][21];	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:51:18, :55:17]
        resHi = _RANDOM[4'h4][22];	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:51:18, :56:18]
        divisor = {_RANDOM[4'h4][31:23], _RANDOM[4'h5], _RANDOM[4'h6][23:0]};	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:51:18, :57:20]

...
module ALUExeUnit_1(
  ...
  output [39:0] io_brinfo_jalr_target,	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:105:14]
  output [20:0] io_brinfo_target_offset,	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:105:14]
  input         io_get_ftq_pc_entry_cfi_idx_valid,	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:105:14]
  input  [2:0]  io_get_ftq_pc_entry_cfi_idx_bits,	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:105:14]
  input         io_get_ftq_pc_entry_start_bank,	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:105:14]
  input  [39:0] io_get_ftq_pc_pc,	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:105:14]
  input         io_get_ftq_pc_next_val,	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:105:14]
  input  [39:0] io_get_ftq_pc_next_pc	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:105:14]
);

  wire        div_busy;	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:380:39]
  wire        _DivUnit_io_req_ready;	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:367:17]
  wire        _DivUnit_io_resp_valid;	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:367:17]
  wire [6:0]  _DivUnit_io_resp_bits_uop_rob_idx;	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:367:17]
  wire [6:0]  _DivUnit_io_resp_bits_uop_pdst;	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:367:17]
  wire        _DivUnit_io_resp_bits_uop_bypassable;	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:367:17]
  wire        _DivUnit_io_resp_bits_uop_is_amo;	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:367:17]
  wire        _DivUnit_io_resp_bits_uop_uses_stq;	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:367:17]
  wire [1:0]  _DivUnit_io_resp_bits_uop_dst_rtype;	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:367:17]
  wire [63:0] _DivUnit_io_resp_bits_data;	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:367:17]
  ...
  assign div_busy = ~_DivUnit_io_req_ready | io_req_valid & io_req_bits_uop_fu_code[4];	// @[generators/boom/src/main/scala/common/micro-op.scala:154:40, generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:367:17, :380:{21,39}, :381:35]
  `ifndef SYNTHESIS	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:426:10]
    wire [1:0] _GEN = {1'h0, _ALUUnit_io_resp_valid} + {1'h0, _DivUnit_io_resp_valid};	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:272:17, :294:15, :367:17, :426:20]
    always @(posedge clock) begin	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:426:10]
      if (~reset & ~(~(_GEN[1]) & ~_DivUnit_io_resp_valid | _GEN != 2'h3 & _DivUnit_io_resp_valid)) begin	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:367:17, :426:{10,20,58,65,68,83}, :427:{58,65}]
  ...
  `endif // not def SYNTHESIS
  ALUUnit ALUUnit (	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:272:17]
    .clock                             (clock),
    .reset                             (reset),
  ...
  DivUnit DivUnit (	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:367:17]
    .clock                          (clock),
    .reset                          (reset),
    .io_req_ready                   (_DivUnit_io_req_ready),
    .io_req_valid                   (io_req_valid & io_req_bits_uop_fu_code[4]),	// @[generators/boom/src/main/scala/common/micro-op.scala:154:40, generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:369:48]
    .io_req_bits_uop_ctrl_op_fcn    (io_req_bits_uop_ctrl_op_fcn),
    .io_req_bits_uop_ctrl_fcn_dw    (io_req_bits_uop_ctrl_fcn_dw),
    .io_req_bits_uop_br_mask        (io_req_bits_uop_br_mask),
    .io_req_bits_uop_rob_idx        (io_req_bits_uop_rob_idx),
    ...
    .io_req_bits_rs2_data           (io_req_bits_rs2_data[63:0]),	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:285:30]
    .io_req_bits_kill               (io_req_bits_kill),
    .io_resp_ready                  (~_ALUUnit_io_resp_valid),	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:272:17, :377:26]
  ...
  assign io_fu_types = {5'h0, ~div_busy, 4'h3};	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:263:{21,22}, :264:45, :380:39]
  assign io_iresp_valid = _ALUUnit_io_resp_valid | _DivUnit_io_resp_valid;	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:272:17, :367:17, :410:71]
  assign io_iresp_bits_uop_rob_idx = _ALUUnit_io_resp_valid ? _ALUUnit_io_resp_bits_uop_rob_idx : _DivUnit_io_resp_bits_uop_rob_idx;	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:272:17, :367:17, src/main/scala/chisel3/util/Mux.scala:50:70]
  assign io_iresp_bits_uop_pdst = _ALUUnit_io_resp_valid ? _ALUUnit_io_resp_bits_uop_pdst : _DivUnit_io_resp_bits_uop_pdst;	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:272:17, :367:17, src/main/scala/chisel3/util/Mux.scala:50:70]
  assign io_iresp_bits_uop_bypassable = _ALUUnit_io_resp_valid ? _ALUUnit_io_resp_bits_uop_bypassable : _DivUnit_io_resp_bits_uop_bypassable;	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:272:17, :367:17, src/main/scala/chisel3/util/Mux.scala:50:70]
  assign io_iresp_bits_uop_is_amo = _ALUUnit_io_resp_valid ? _ALUUnit_io_resp_bits_uop_is_amo : _DivUnit_io_resp_bits_uop_is_amo;	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:272:17, :367:17, src/main/scala/chisel3/util/Mux.scala:50:70]
  assign io_iresp_bits_uop_uses_stq = _ALUUnit_io_resp_valid ? _ALUUnit_io_resp_bits_uop_uses_stq : _DivUnit_io_resp_bits_uop_uses_stq;	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:272:17, :367:17, src/main/scala/chisel3/util/Mux.scala:50:70]
  assign io_iresp_bits_uop_dst_rtype = _ALUUnit_io_resp_valid ? _ALUUnit_io_resp_bits_uop_dst_rtype : _DivUnit_io_resp_bits_uop_dst_rtype;	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:272:17, :367:17, src/main/scala/chisel3/util/Mux.scala:50:70]
  assign io_iresp_bits_data = {1'h0, _ALUUnit_io_resp_valid ? _ALUUnit_io_resp_bits_data : _DivUnit_io_resp_bits_data};	// @[generators/boom/src/main/scala/exu/execution-units/execution-unit.scala:272:17, :294:15, :367:17, :413:24, src/main/scala/chisel3/util/Mux.scala:50:70]
